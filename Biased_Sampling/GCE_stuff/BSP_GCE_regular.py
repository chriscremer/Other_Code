	...
	for bias in bias_set:
		...
		with tf.Session() as sess:
			...
			for iter_ in range(999999):
				...
				# cur_ind = iter_ % len(train_y_alt)
				# batch = [train_x_alt[cur_ind:cur_ind+batch_size], train_y_alt[cur_ind:cur_ind+batch_size]]
				# batch, cur_ind = tools.next_batch2(train_x_alt, train_y_alt, batch_size, cur_ind)
...
#save results
with open('results_regular_10.pkl', "wb" ) as f:
