...
if args.model == 'standard':
    ...
    experiment_log = this_dir+'/log_eval.txt'
...
for ckt in checkpoints:
    ...
    AIS_train = test_ais(model=model, data_x=train_x, batch_size=batch_size_AIS, display=100, k=k_AIS, n_intermediate_dists=n_intermediate_dists)
    ...
    AIS_test = test_ais(model=model, data_x=test_x, batch_size=batch_size_AIS, display=100, k=k_AIS, n_intermediate_dists=n_intermediate_dists)
