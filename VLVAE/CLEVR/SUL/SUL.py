...
if __name__ == "__main__":
    ...
    # colors = ['gray', 'blue', 'red', 'brown', 'purple', 'yellow', 'green', 'cyan']
    colors = ['blue', 'green', 'cyan', 'red', 'purple', 'yellow']
    ...
    if args.singlev2:
        ...
        for i in range(len(train_question_dataset)):
            ...
            if color in colors:
                ...
                if colors_count[color_idx] < 1000:

                    new_trainset_indexes.append(i)
                    colors_count[color_idx] +=1

                # print (color_idx)
                # fsdf
        print (colors_count)

        train_indexes = new_trainset_indexes




        colors_count2 = [0,0,0,0,0,0]
        new_validset_indexes = []
        ...
        for i in range(len(val_question_dataset)):
            ...
            color = sentence[1]
            if color in colors:
                new_validset_indexes.append(i)
                color_idx = colors.index(color)
                colors_count2[color_idx] +=1

        val_indexes = new_validset_indexes
        print (colors_count2)
        fdsfa



            # if sentence[1] not in colors:
            #   colors.append(sentence[1])
            # print (sentence)
            # fdsf
