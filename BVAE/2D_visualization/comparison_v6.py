...
# implement backwards trajectory
...
def reverse_hamiltonian_sampling(n_samples, log_posterior, z_init, v_init):
    '''
    n_samples: [1]
    log_posterior: function that takes a 2d point
    '''
...
if __name__ == '__main__':
    ...
    zT_0, log_w0, z0_0, vT_0 = hamiltonian_sampling(n_samples, log_posterior_0)
    zT_1, log_w1, z0_1, vT_1 = hamiltonian_sampling(n_samples, log_posterior_1)
    zT_2, log_w2, z0_2, vT_2 = hamiltonian_sampling(n_samples, log_posterior_2)
    zT_3, log_w3, z0_3, vT_3 = hamiltonian_sampling(n_samples, log_posterior_3)

    r_z0_0 = reverse_hamiltonian_sampling(n_samples, log_posterior_0, zT_0, vT_0)
    r_z0_1 = reverse_hamiltonian_sampling(n_samples, log_posterior_1, zT_1, vT_1)
    r_z0_2 = reverse_hamiltonian_sampling(n_samples, log_posterior_2, zT_2, vT_2)
    r_z0_3 = reverse_hamiltonian_sampling(n_samples, log_posterior_3, zT_3, vT_3)
