...
#just changing which variables are being used.
...
if __name__ == '__main__':
    ...
    list_of_n_qz_transformations = [0,3] 
    ...
    for n_qz_transformations in list_of_n_qz_transformations:

        for decoder in list_of_decoders:

            for ga in list_of_ga:
                ...
                hyperparams = {
                    ...
                    'ga':  ga, #'none', #'hypo_net',
                    'n_qz_transformations': n_qz_transformations,
                    'decoder':  decoder, #'MNF', #'BNN',
                    # 'n_W_particles': 2,
                    # 'n_z_particles': 3,
                    'qW_weight': qW_weight,
                    'lmba': lmba}
                ...
                exp_settings_name =   'BVAE_qzT_' + str(n_qz_transformations) + '_px_'+decoder + '_ga_'+ga + '_epochs'+str(epochs) #+'_smalldata_smalldec'
