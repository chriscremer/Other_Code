...
if __name__ == '__main__':
    ...
    # # Train
    # epochs = 100
    # path_to_load_variables = path_for_variables + 'model.ckpt'
    # path_to_save_variables = path_for_variables + 'model.ckpt'
    ...
    if 1:
        ...
        experiment_log = path_for_variables+'experiment_' + date_ + '_' +time_2 +'.txt'
        ...
        # list_of_models = ['vae','iwae', 'hiae'] #['iwae', 'vae']  #mog vae vs mog iwae
        list_of_models = ['bvae'] #['iwae', 'vae']  #mog vae vs mog iwae



        # list_model_structures = range(4)
        list_of_k_samples = [10] #[50,10,1] #[1,5,50] #[1,3,12,60]
        # list_of_donts = [[]]  #[c,k]
        ...
        for k in list_of_k_samples:
            ...
            for m in list_of_models:
                ...
                for arch in list_of_archs_i:
                    ...
                    saved_parameter_file = m+ str(arch) + '_z' + str(list_of_archs[arch]['n_z']) + '_k' + str(k) + '_epochs'+str(epochs)+'.ckpt' 
                    ...
                    if saved_parameter_file in os.listdir(path_for_variables):
                        ...
                        if m == 'vae':
                            ...
                            model = HIAE(list_of_archs[arch], batch_size=n_batch, n_particles=k)
                        elif m == 'bvae':
                            model = BVAE(list_of_archs[arch], batch_size=n_batch, n_particles=k)
                        start = time.time()
                        ...
                        model.train(train_x=train_x, valid_x=valid_x, display_step=9000, 
                                    path_to_load_variables='', 
                                    path_to_save_variables=path_for_variables+saved_parameter_file, 
                                    epochs=epochs)
                    ...
                    if m == 'vae':
                        ...
                        model = HIAE(list_of_archs[arch], batch_size=1, n_particles=k_evaluation)
                    ...
                    #Load parameters
                    model.load_parameters(path_to_load_variables=path_for_variables+saved_parameter_file)
