...
def plot_iw_isocontours(ax, p, q, sampler, k=3, xlimits=[-6, 6], ylimits=[-6, 6], numticks=101, n_sample_batches=10, cmap='Blues'):
...
if __name__ == '__main__':
    ...
    samples = sess.run(sample_proposal(tf.convert_to_tensor(10, dtype='int32')))
    ...
    plt.ylim(-6, 6)
    plt.gca().set_aspect('equal', adjustable='box')
    ax.annotate('Samples', xytext=(.2, 1.1), xy=(0, 1), textcoords='axes fraction')
