...
if __name__ == '__main__':
    ...
    # posteriors = [ ttp.log_posterior_1]
    # posterior_names = ['top_bot']


    # posteriors = [ ttp.log_posterior_2]
    # posterior_names = ['vert_hori']

    # posteriors = [ ttp.logprob_two_moons]
    # posterior_names = ['two_moons']
