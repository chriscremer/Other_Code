...
# giving it pz now. which i didnt think it needed.
...
class Gaussian_SVI(object):
    ...
    def __init__(self, n_particles=1):
        ...
        # self.elbo = tf.log(tf.reduce_mean(tf.exp(log_w-max_))) +max_ #[1]
...
if __name__ == '__main__':
    ...
    for i in range(10000):
        ...
        #Get log_p_x
        log_px = G_SVI.sess.run(G_SVI.log_px, feed_dict={G_SVI.sample_q: x})
        ...
        if i%500==0:
            ...
            w_samples = iw_sampling(G_SVI, k=n_particles)
