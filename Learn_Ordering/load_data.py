...
def load_flickr(data_dir, data_dir_test, dataset_size=None):
    ...
    if dataset_size is not None:
        ...
        train_dataset = LimitDataset(train_dataset, n=dataset_size)
...
def load_clevr(batch_size, data_dir, quick=0):
    ...
    class MyClevrDataset(Dataset):
        ...
        def __getitem__(self, idx):
            ...
            img_batch = img_batch * 255. / 256. #fixing a mistake from before
