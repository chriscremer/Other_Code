...
# Experiment 
##################
exp_name = 'RoadRunner'# 'eval_imitator_env_3' # 'confirm_monitor_works_mbrl'# # 'train_imitator'
envs = ['RoadRunner'] #['Breakout'] #['Enduro'] #['Seaquest'] # , ,  #['Kangaroo'] ## #['Freeway'] ###,,,,, 'BeamRider', 'Alien', 
            # 'Amidar','Assault', 'Freeway',
            # 'MontezumaRevenge','Venture','Zaxxon','PrivateEye', 'Gopher']
