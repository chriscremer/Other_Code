...
# # Experiment 
# ##################
# exp_name = 'confirm_works_1_withloadingpong_playingbreakout_2'
# envs = ['Breakout'] #['Enduro'] #['Seaquest'] # , ,  #['Kangaroo'] ## #['Freeway'] ###,,,,, 'BeamRider', 'Alien', 
#             # 'Amidar','Assault', 'Freeway',
#             # 'MontezumaRevenge','Venture','Zaxxon','PrivateEye', 'Gopher']
# models_list = [ms.a2c_load_6M, ms.a2c_load_9M] # [ms.a2c, ms.a2c_load_3M] #  #  #[ms.a2c_load]  #[ms.a2c_traj_action_mask] #  # #,   #[]  # # # # #[ms.a2c_with_var]  # #[ms.a2c_sgd]#  #[ms.a2c_list]  #  #[mf.a2c_dropout]  mf.ppo_linear] # [mf.ppo_v1]# [mf.a2c_long] 
# which_gpu = 0
...
# save_interval=4e6 #save model params and videos and gifs
# save_params = 1
# vid_ = 0
# gif_ = 0
# ls_ = 0
...
# Experiment 
##################
exp_name = 'RoadRunner_colour' # 'breout_colour' ## 'eval_imitator_env_3' # 'confirm_monitor_works_mbrl'# # 'train_imitator'
envs =  ['RoadRunner']  #['Breakout'] #  #['Breakout'] #['Enduro'] #['Seaquest'] # , ,  #['Kangaroo'] ## #['Freeway'] ###,,,,, 'BeamRider', 'Alien', 
            # 'Amidar','Assault', 'Freeway',
            # 'MontezumaRevenge','Venture','Zaxxon','PrivateEye', 'Gopher']
...
save_interval=5e5 -1 #save model params and videos and gifs
save_params = 0
vid_ = 0
gif_ = 0
ls_ = 0
...
for env in envs:
    ...
    for model_dict in models_list:
        ...
        for iter_i in range(seed_offset,seed_offset+iters):
            ...
            # subprocess.call("(cd "+code_location+" && python eval_imitator.py --m {})".format(json_path), shell=True) 
            # subprocess.call("(cd "+code_location+" && python make_dataset.py --m {})".format(json_path), shell=True) 
            # subprocess.call("(cd "+code_location+" && python train_imitator_on_env.py --m {})".format(json_path), shell=True) 
            print('')
