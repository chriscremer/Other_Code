...
# Idea here is to only compare the top action, not the whole q distribution. 
    # this will hopefully allow it to ignore more
#   I dont expect it to change much, since computing the top value requies seeign everything 
    ...
    def train(self, epochs, DQN, memory, game):
        ...
        for epoch in range(epochs):
            ...
            for learning_step in range(learning_steps):
                ...
                if total_steps%display_step==0 and epoch>0: # and batch_idx == 0:
...
if __name__ == '__main__':
    ...
    # exp_path_2 = exp_path + '2DQNs_biasframe_v2/'
