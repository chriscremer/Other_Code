...
if __name__ == '__main__':
    ...
    maskpredictor_savefile = exp_path + 'maskpredictor_4.pth'
    ...
    MP = MASK_PREDICTOR()
    load_params_v3(save_dir=exp_path, model=MP, epochs=19)
    MP.cuda()
    ...
    if train_maskpredictor_:
        ...
        print("Training")
        MP.train(epochs=epochs, DQN=DQN, memory=memory, game=game)

        save_params_v3(save_dir=exp_path, model=MP, epochs=epochs)
    ...
    if viz_:
        ...
        numb = 9
        gif_dir = exp_path + 'mask_gif'+str(numb)+'/'
