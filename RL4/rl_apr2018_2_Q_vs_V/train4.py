...
from train_utils import do_vid, do_gifs, do_params, do_ls, update_ls_plot, save_params_v2, load_params_v2, update_error_plot
...
def train(model_dict):
    ...
    for j in range(num_updates):
        ...
        for step in range(num_steps):
            ...
            V, Q = agent.actor_critic.get_V_and_Q(Variable(agent.rollouts.states[step]), one_hot_action)
            Vs.append(V)
            Qs.append(Q)
