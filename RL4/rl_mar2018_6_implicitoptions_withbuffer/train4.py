        ...
        if buffer_:
            ...
            # if 1:
                ...
                for i in range(buffer_steps):
                    ...
                    discrim_errors = discrim_predictions(model_dict, states_batch, actions_batch, discriminator)
            ...
            #Optimize agent
            discrim_errors = discrim_predictions(model_dict, agent.rollouts.states, agent.rollouts.actions, discriminator)
            discrim_errors_reverse = discrim_predictions(model_dict, agent.rollouts.states, agent.rollouts.actions, discriminator, reverse=True)
