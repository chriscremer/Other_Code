...
from train_utils import do_vid, do_gifs, do_params, do_ls, update_ls_plot, view_reward_episode, do_prob_state, save_params_v2
...
def train(model_dict):
    ...
    # print (agent.actor_critic.state_dict())

    # for i in agent.actor_critic.state_dict():
    #     print (i, agent.actor_critic.state_dict()[i].size())
    ...
    # save_params_v2(save_dir, agent, 111, model_dict)
    # dffasd
    ...
    for j in range(num_updates):
        ...
        if j % log_interval == 0:# and j!=0:
            ...
            to_print_legend_string = "Upts, n_timesteps, min/med/mean/max, FPS, total_T, step_T" #, d" #scrim_E"#, elbo"
            start2 = time.time()
