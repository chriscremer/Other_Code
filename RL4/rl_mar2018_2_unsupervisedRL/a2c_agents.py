...
from actor_critic_net_with_context import CNNPolicy
...
class a2c_with_context(object):
    ...
    def __init__(self, hparams):
        ...
        self.actor_critic = CNNPolicy(self.obs_shape[0], hparams['action_space'], hparams['n_contexts'])
    ...
    def act(self, current_state, context):

        # value, action = self.actor_critic.act(current_state)
        # [] [] [P,1] [P]
        value, action, action_log_probs, dist_entropy = self.actor_critic.act(current_state, context)
    ...
    def update(self, context_onehot, discrim_error):
        ...
        discrim_error = discrim_error.view(self.num_processes, 1).detach()
        ...
        advantages = -discrim_error - values #(-.7)#values
    ...
    def update2(self, context_onehot, discrim_error, grad_sum):
        ...
        # print (grad_sum)
        cost = action_loss + value_loss*self.value_loss_coef - dist_entropy.mean()*self.entropy_coef - grad_sum*100000.
