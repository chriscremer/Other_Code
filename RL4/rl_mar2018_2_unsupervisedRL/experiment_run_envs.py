...
# Experiment 
##################
exp_name = 'testing_URL2'
envs =  ['Breakout'] #['MontezumaRevenge'] ## ['Kangaroo', 'Freeway',] #[ ] ## 'Seaquest', #['Kangaroo']  , , 'Enduro', 'Pong']  #['Pong']#['MontezumaRevenge'] #['Enduro']['Seaquest']   # # ## # , ,  ### # ###,,,,, 'BeamRider', 'Alien', 
            # 'Amidar','Assault', 'Freeway',
            # ,'Venture','Zaxxon','PrivateEye', 'Gopher']
models_list = [ms.a2c_adam] #_1step] #, ms.a2c_adam_10step, ms.a2c_adam_50step] #  [ms.a2c_over, ms.a2c_under, ms.a2c_adam] # [] #[ms.a2c_adam] # ## [ms.a2c_adam_1] #  # #  # #, #[ms.a2c_traj_action_mask] #  # #,   #[]  # # # # #[ms.a2c_with_var]  # #[ms.a2c_sgd]#  #[ms.a2c_list]  #  #[mf.a2c_dropout]  mf.ppo_linear] # [mf.ppo_v1]# [mf.a2c_long] 
which_gpu = 1
...
explore_ = 0
grad_var_ = 0
code_location = home+"/Other_Code/RL4/rl_mar2018_2_unsupervisedRL/"
#####################
