...
# def do_gifs1(envs, agent, model_dict, update_current_state, update_rewards, total_num_steps):
#     save_dir = model_dict['save_to']
...
#             action_prob = agent.actor_critic.action_dist(Variable(agent.rollouts.states[step], volatile=True))[0]
...
# def do_gifs2(envs, agent, model_dict, update_current_state, update_rewards, total_num_steps):
#     save_dir = model_dict['save_to']
#     shape_dim0 = model_dict['shape_dim0']
#     num_processes = model_dict['num_processes']
#     obs_shape = model_dict['obs_shape']
...
#             #     # Act, [P,1], [P,1]
#             #     # action, value = agent.act(Variable(agent.rollouts.states[step], volatile=True))
#             #     action, value = agent.act(Variable(agent.rollouts_list.states[-1], volatile=True))
...
#             # Agent record step
#             # agent.insert_data(step, current_state, action.data, value.data, reward, masks)
#             agent.rollouts_list.insert(step, current_state, action.data, value.data, reward, masks)
...
#         # for step in range(num_steps):
#         for step in range(len(state_frames)):
...
#             print (len(agent.rollouts_list.returns))
#             print (step)
