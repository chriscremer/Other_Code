...
# Experiment 
##################
exp_name = 'testing_justcahngedfolder_and_codelocation_and_dtypeandnets_and_saving_reverseddtype_again2'
...
vae_ = 0
explore_ = 0
# code_location = home+"/Other_Code/RL4/rl_mar2018_9_transfer_and_implicit3/"
...
#             # 'Amidar','Assault', 'Freeway',
#             # ,'Venture','Zaxxon','PrivateEye', 'Gopher']
# models_list = [ms.a2c_adam_1step, ms.a2c_adam_10step, ms.a2c_adam_50step] #  [ms.a2c_over, ms.a2c_under, ms.a2c_adam] # [] #[ms.a2c_adam] # ## [ms.a2c_adam_1] #  # #  # #, #[ms.a2c_traj_action_mask] #  # #,   #[]  # # # # #[ms.a2c_with_var]  # #[ms.a2c_sgd]#  #[ms.a2c_list]  #  #[mf.a2c_dropout]  mf.ppo_linear] # [mf.ppo_v1]# [mf.a2c_long] 
# which_gpu = 1
...
# save_interval= 3e6 #save model params and videos and gifs
# save_params = 0
# vid_ = 0
# gif_ = 0
# ls_ = 0
# vae_ = 0
# explore_ = 0
# code_location = home+"/Other_Code/RL4/rl_feb2018_1/"
# #####################
