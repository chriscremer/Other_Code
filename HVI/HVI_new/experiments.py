    ...
    for T in list_of_T:
        ...
        for m in list_of_models:
            ...
            for z_size in z_sizes:
                ...
                saved_parameter_file = m + '_T'+str(T) + '_z'+str(z_size) + '_epochs'+str(epochs)+'.ckpt' 
                ...
                info = model.eval(data=test_x, batch_size=n_batch_eval, display_step=1000,
