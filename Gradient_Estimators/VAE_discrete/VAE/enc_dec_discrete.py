...
class Encoder(nn.Module):
    def __init__(self, kwargs, input_nc, image_encoding_size, n_residual_blocks=3, input_size=112, ):
        ...
        model.append(nn.Linear(128, self.z_size))
...
class Decoder(nn.Module):
    def __init__(self, kwargs, z_size, output_nc, n_residual_blocks=3, output_size=112):
        ...
        model.append(nn.ConvTranspose2d(128, 12, 8, stride=1, padding=0)) #[B,12,8,8] 
        ...
        model.append(nn.ConvTranspose2d(12, 256, 3, stride=1, padding=1)) #, output_padding=1)) #[20*28*28]
