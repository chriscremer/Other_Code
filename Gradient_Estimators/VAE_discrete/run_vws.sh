...
python3 run_vae_cifar_discrete.py --exp_name "vae_discrete_checkunbiased" \
...
# python3 run_vae_cifar_discrete.py --exp_name "vae_discrete_relax_trainjustencoder1" \
# 								--z_size 200 --batch_size 64 \
# 								--enc_res_blocks 3 --dec_res_blocks 3  --n_prior_flows 5 \
# 								--which_gpu '0' \
# 								--data_dir "$HOME/Documents/" \
...
# python3 run_vae_cifar_discrete.py --exp_name "vae_discrete_simplax2_trainjustencoder" \
# 								--z_size 200 --batch_size 64 \
# 								--enc_res_blocks 3 --dec_res_blocks 3  --n_prior_flows 5 \
# 								--which_gpu '0' \
# 								--data_dir "$HOME/Documents/" \
...
# python3 run_vae_cifar_discrete.py --exp_name "vae_discrete_simplax2" \
# 								--z_size 200 --batch_size 64 \
# 								--enc_res_blocks 3 --dec_res_blocks 3  --n_prior_flows 5 \
# 								--which_gpu '0' \
# 								--data_dir "$HOME/Documents/" \
...
# 								--params_load_dir "$HOME/Documents/VAE2_exps/vae_discrete_simplax/params/" \
# 								--model_load_step 0 \
# 								--save_output 1



# python3 run_vae_cifar_discrete.py --exp_name "vae_discrete" \
# 								--z_size 200 --batch_size 64 \
# 								--enc_res_blocks 3 --dec_res_blocks 3  --n_prior_flows 5 \
# 								--which_gpu '0' \
# 								--data_dir "$HOME/Documents/" \
...
# 								--save_params_step 50000 --max_steps 400000 \
# 								--warmup_steps 20000 --continue_training 0 \
# 								--params_load_dir "$HOME/Documents/VAE2_exps/vae_discrete/params/" \
# 								--model_load_step 0 \
# 								--save_output 1
