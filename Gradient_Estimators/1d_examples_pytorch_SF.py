...
if __name__ == "__main__":
    ...
    for i in range(n_grads):
        ...
        #Compute grad
        log_qp_avg = torch.mean(log_qp) - 8.8
        # print (log_qp_avg)
        # fsd
        # log_qp_avg.backward()
        # print (log_q_avg)
    ...
    #Plot mean grads histogram
    ax = plt.subplot2grid((rows,cols), (3,0), frameon=False, colspan=1)
    ...
    #Plot logvar grads histogram
    ax = plt.subplot2grid((rows,cols), (3,1), frameon=False, colspan=1)
    ...
    #Plot mean grads histogram
    ax = plt.subplot2grid((rows,cols), (4,0), frameon=False, colspan=1)
    ...
    #Plot logvar grads histogram
    ax = plt.subplot2grid((rows,cols), (4,1), frameon=False, colspan=1)
    ...
    # name_file = home+'/Downloads/grads_estimators_SF_Baseline.pdf'
