...
ax.plot(steps, smooth_list(losses4), label='REINFORCE H(z)', alpha=.8)
...
ax.plot(steps, smooth_list(losses11), label='REINFORCE H(z)')
...
ax.plot(steps, smooth_list(losses12), label='REINFORCE H(z)')
