...
if __name__ == "__main__":
    ...
    objective = lambda x: (q_x.log_prob(x) - p_x.log_prob(x))
    ...
    x1, y1 = return_1d_evaluation(eval_this=objective, xlimits=[-3,-2], numticks=5)
    x2, y2 = return_1d_evaluation(eval_this=q_x.log_prob, xlimits=[-3,-2], numticks=5)
    x3, y3 = return_1d_evaluation(eval_this=p_x.log_prob, xlimits=[-3,-2], numticks=5)
