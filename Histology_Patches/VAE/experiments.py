...
if __name__ == '__main__':
    ...
    load_from = home + '/Documents/histo_patches/'

    #Load histo patches
    with open(load_from+'prostate_carcinoma_mar27_2017.pkl', 'rb') as f:
    ...
    # plt.imshow(patches[1000], cmap='gray') 
    # plt.show()
    # fa

    n_batch = 20
    epochs = 100
    path_to_load_variables = home + '/Documents/tmp/histo_params.ckpt'
    path_to_save_variables = home + '/Documents/tmp/histo_params.ckpt'

    model = VAE(batch_size=n_batch)
    model.train(train_x=patches, valid_x=[], display_step=500, epochs=epochs,
