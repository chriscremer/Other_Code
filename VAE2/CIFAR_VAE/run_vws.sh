...
python3 run_vae_cifar_gradmatching.py --exp_name "vae_cifar_just_seeing_if_it_works2" \
								...
								--display_step 100 --start_storing_data_step 2001 \
...
# python3 run_vae_cifar.py --exp_name "vae_cifar_just_seeing_if_it_works" \
# 								--z_size 384 --batch_size 64 \
# 								--enc_res_blocks 3 --dec_res_blocks 3  --n_prior_flows 5 \
# 								--which_gpu '0' \
# 								--data_dir "$HOME/Documents/" \
