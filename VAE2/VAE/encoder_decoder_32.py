...
class Encoder(nn.Module):
    def __init__(self, input_nc, image_encoding_size, n_residual_blocks=3, input_size=112):
        ...
        # [256*28*28]
        feats = 32
        model.append(nn.Conv2d(in_features, feats, 3, stride=1, padding=1)) #[20*28*28]
...
class Decoder(nn.Module):
    def __init__(self, z_size, output_nc, n_residual_blocks=3, output_size=112):
        ...
        model.append(nn.ConvTranspose2d(32, 128, 3, stride=1, padding=1)) #, output_padding=1)) #[20*28*28]
        model.append(nn.InstanceNorm2d(128))
