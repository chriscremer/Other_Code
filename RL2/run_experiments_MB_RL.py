...
if __name__ == "__main__":
    ...
    # model_path_to_load_variables=save_to + 'dkf_ball_vars.ckpt'
    model_path_to_load_variables=''
    model_path_to_save_variables=save_to + 'mb_rl_model.ckpt'
    # model_path_to_save_variables=''

    # policy_path_to_load_variables=save_to + 'dkf_ball_vars.ckpt'
    policy_path_to_load_variables=''
    policy_path_to_save_variables=save_to + 'mb_rl_policy.ckpt'
