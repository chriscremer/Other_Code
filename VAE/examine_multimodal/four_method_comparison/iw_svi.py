...
class Univariate_Gaussian_SVI():
    ...
    def __init__(self, learning_rate=0.001, n_particles=1):
        ...
        self.p_z = tf.maximum(self.p_z(self.z), 0.000001) #prevent -inf when applying log
...
if __name__ == "__main__":
    ...
    for i in range(10000):
        ...
        _, elbo, m, v, p, q = sess.run([SVI.optimizer, SVI.elbo, SVI.mean, SVI.log_var, SVI.log_p_z, SVI.log_q_z])
