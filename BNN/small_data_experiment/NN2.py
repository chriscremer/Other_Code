...
class NN(object):
    ...
    def model(self, x):
        ...
        for layer_i in range(len(net)-1):
            ...
            W = tf.reshape(W_means, [1,input_size_i, output_size_i])
            W = tf.tile(W, [self.n_particles,1,1]) #[P,I,O]
    ...
    def train(self, train_x, train_y, valid_x=[], valid_y=[], display_step=[1,100], path_to_load_variables='', path_to_save_variables='', epochs=10, batch_size=20, n_particles=3):
        '''
        Train.
        '''
        random_seed=1
...
if __name__ == '__main__':
    ...
    model.train(train_x=train_x, train_y=train_y, 
                epochs=1, batch_size=20, n_particles=2, display_step=[1,1000],
                path_to_load_variables=path_to_load_variables,
                path_to_save_variables=path_to_save_variables)


    print 'Testing'
    iwae_elbo = model.eval(test_x, test_y, path_to_load_variables=path_to_save_variables, batch_size=2, n_particles=10)
    print iwae_elbo
