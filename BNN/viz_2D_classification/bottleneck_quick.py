...
class BNN_bottleneck(object):
    ...
    def __init__(self, n_classes):
        ...
        first_half_NN = BNN([784, 100, 100, 2], [tf.nn.softplus,tf.nn.softplus, None])
        ...
        Ws1, log_p_W_sum1, log_q_W_sum1 = first_half_NN.sample_weights()
        Ws, log_p_W_sum, log_q_W_sum = second_half_BNN.sample_weights()

        #Feedforward: [B,P,Y], [P], [P]
        self.y1 = first_half_NN.feedforward(self.x, Ws1)
        ...
        self.cost = softmax_error +  self.one_over_N*(-log_p_W_sum-log_p_W_sum1 + log_q_W_sum+log_q_W_sum1)# + .00001*first_half_NN.weight_decay()
