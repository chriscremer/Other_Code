...
class BNN_bottleneck(object):
    ...
    def __init__(self, n_classes):
        ...
        second_half_BNN = NN([2,100, 100, n_classes], [tf.nn.softplus,tf.nn.softplus, None])
        ...
        self.cost = softmax_error + .00001*first_half_NN.weight_decay() +  self.one_over_N*(.5*second_half_BNN.weight_decay())
...
if __name__ == '__main__':
    ...
    path_to_save_variables=home+'/Documents/tmp/vars_5_classes_NN.ckpt'
