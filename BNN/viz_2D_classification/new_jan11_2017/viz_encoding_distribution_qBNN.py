...
from bottleneck_BNN_q import bottleneck_BNN
...
if __name__ == '__main__':
    ...
    hyper_config = { 
                    ...
                    'first_half': [[x_size,200],[200,200],[200,z_size]],
                    'second_half': [[z_size,200],[200,200],[200,n_limited_classes]],
                    'use_gpu': False,
                    'which_gpu': '0'
                }
    ...
    if viz_:
        ...
        n = 50 #number of differnet datapoints
        n_s = 2 #number of samples to take
