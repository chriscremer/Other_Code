...
class BNN_MNIST(object):
    ...
    def __init__(self, n_classes, prior_variance):
        ...
        second_half_BNN = BNN([self.input_size, 20, 20, n_classes], [tf.nn.softplus,tf.nn.softplus, None], prior_variance)
...
if __name__ == '__main__':
    ...
    # prior_variances = [.001, .01, .1, 1., 10.]
    prior_variances = [.01, .1, 1., 10.]
    ...
    for prior_var in range(len(prior_variances)):
        ...
        if plot_training_curves:
            ...
            fig.suptitle('Prior Variance '+str(prior_variances[prior_var]), fontsize=7)
            ...
            plt.savefig(home+'/Documents/tmp/vars_emp_bayes_'+str(int(prior_var))+'.png')
            print 'saved fig to ' + home+'/Documents/tmp/vars_emp_bayes_'+str(int(prior_var))+'.png'
            print 
