...
#Neural Network to BNN

# step 1: add particles, where theyll all be the same. this test the shapes and stuff
# or only have one particle, so make bnn but one particle
