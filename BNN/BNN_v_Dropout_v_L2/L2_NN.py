...
class L2_NN(object):
    ...
    def __init__(self, network_architecture, act_functions, lmba):
        ...
        #Likelihood
        self.softmax_error = tf.reduce_mean(tf.nn.softmax_cross_entropy_with_logits(labels=self.y, logits=self.y_))
        ...
        #For evaluation
        self.prediction = tf.nn.softmax(self.y_) 
